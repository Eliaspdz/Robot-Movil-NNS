...
plt.plot(vector_x_id,label='x identificada')
plt.title('Vector X')
plt.grid(True)

plt.subplot(2, 3, 3)
plt.plot(vector_y,label='y')
plt.plot(vector_y_id,label='y identificada')
plt.title('Vector Y')
plt.grid(True)

plt.subplot(2, 3, 4)
plt.plot(vector_theta,label='theta')
plt.plot(vector_theta_id,label='theta identificada')
